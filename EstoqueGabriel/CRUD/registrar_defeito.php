<?php
    ...
    if (isset($_GET['defeito'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $atualizacao = $pdo->prepare("UPDATE produto SET problema_prod = :problema_prod, quantidade_def = quantidade_def + :quantidade_def WHERE id_prod = :defeito");
            ...
            <div class='container text-center mt-5'>
                ...
                <div class='mt-3'>
                    <form method='POST'>
                        ...
                        <a type='submit' class='btn btn-green'>Salvar</a>
                    </form>
                </div>
            </div>
            <?php
